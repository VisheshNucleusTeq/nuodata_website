...
import HeaderCss from "../../styles/newStyles/headerNew.module.css";
  ...
  return (
    ...
    >
      <Row className={HeaderCss.infoRow}>
        <Col offset={eventData.length > 0 ? 2 : 3} md={2} xs={8} sm={6}>
        ...
        <Col md={eventData.length > 0 ? 18 : 20} xs={14} sm={16}>
          <Menu
