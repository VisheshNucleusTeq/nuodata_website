  ...
  const leftTextData = [
    {
      bgColor1: "#ff8860",
      bgColor2: "#fff281",
      iconSrc: "/all-graph/how it works/define/demo/Define-icon.html",
      title: "Define",
      description:
      ...
      graphSrc: "/all-graph/how it works/define/demo/Define.html",
    },
    {
      bgColor1: "#6015E2",
      bgColor2: "#FB4794",
      iconSrc: "/all-graph/how it works/connect/demo/connect-icon.html",
      title: "Connect",
      description:
        "Connect with source platform(s) Upload ETLs & configuration files",
      pipelineImgSrc: "/how_it_work/purple-pipeline.png",
      graphSrc: "/all-graph/how it works/connect/demo/data.html",
    },
    {
      bgColor1: "#ff8860",
      bgColor2: "#fff281",
      iconSrc: "/all-graph/how it works/Analyze/analyze-icon/demo/data.html",
      title: "Analyze",
      description:
        "Analyze workloads & transformations Identify cost & effort savings",
      pipelineImgSrc: "/how_it_work/yellow-pipeline.png",
      graphSrc: "/all-graph/how it works/Analyze/demo/data.html",
    },
    {
      bgColor1: "#29D5A6",
      bgColor2: "#29B8EF",
      iconSrc: "/all-graph/how it works/Design/Design-icon/demo/data.html",
      title: "Design",
      description:
        "Create a single version of truth Optimize queries & ETLs with self service UI",
      pipelineImgSrc: "/how_it_work/green-pipeline.png",
      graphSrc: "/all-graph/how it works/Design/demo/data.html",
    },
    {
      bgColor1: "#ff8860",
      bgColor2: "#fff281",
      iconSrc: "/all-graph/how it works/Transform/demo/Transform-icon.html",
      title: "Transform",
      description:
        "Create modernization projects at business unit evel(s) Select any source and any target platform for your modernization",
      pipelineImgSrc: "/how_it_work/yellow-pipeline.png",
      graphSrc: "/all-graph/how it works/Transform/demo/data.html",
    },
    {
      bgColor1: "#6015E2",
      bgColor2: "#FB4794",
      iconSrc: "/all-graph/how it works/validate/demo/validate-icon.html",
      title: "Validate",
      description:
        "Validate your transformation and check out exceptions, if any",
      pipelineImgSrc: "/how_it_work/purple-pipeline.png",
      graphSrc: "/all-graph/how it works/validate/demo/data.html",
    },
    {
      bgColor1: "#29D5A6",
      bgColor2: "#29B8EF",
      iconSrc: "/all-graph/how it works/rollout/demo/rollout-icon.html",
      title: "Rollout",
      description:
        "Get ready to deploy directly in the target platform of choice",
      pipelineImgSrc: "/how_it_work/green-pipeline.png",
      graphSrc: "/all-graph/how it works/rollout/demo/data.html",
    },
  ];
